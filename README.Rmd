...
[![CRAN status](https://www.r-pkg.org/badges/version/rsciinema)](https://cran.r-project.org/package=rsciinema)
[![Linux Build Status](https://travis-ci.org/gaborcsardi/rsciinema.svg?branch=master)](https://travis-ci.org/gaborcsardi/rsciinema)
<!-- badges: end -->
...
See the [`inst/examples` directory](https://github.com/gaborcsardi/rsciinema/tree/master/inst/examples)
for these examples.
...
```{r echo = FALSE, results = "asis"}
cat("```\n")
cat(readLines("inst/examples/rsciinema.R"), sep = "\n")
cat("```\n")
```
