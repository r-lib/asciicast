# Contributing to asciicast

This outlines how to propose a change to asciicast. For more detailed
...
Please note that the asciicast project is released with a [Contributor
Code of Conduct](https://asciicast.r-lib.org/dev/CODE_OF_CONDUCT.md). By
